from KnowledgeBase import check_entailment
...
ent1 = check_entailment(s1, P)
ent2 = check_entailment(s2, R)
ent3 = check_entailment(s3, R)
ent4 = check_entailment(s4, P)
ent5 = check_entailment(s5, Q)
